...
from evaluator.color_utils import group_color, calculate_similarity_single
    ...
    def _calculate_metrics(self, generation_colors: List[Tuple], golden_colors: List[Tuple]):
        ...
        def calculate_similarity_parallel(lst1, lst2):
            ...
            with ThreadPoolExecutor(max_workers=cpu_count()) as executor:
                similarities = list(executor.map(calculate_similarity_for_permutation, [(shorter, perm) for perm in perms]))
