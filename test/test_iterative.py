...
if __name__ == "__main__":
    ...
    actor_config = ActorConfig(name="Test Actor", model_name="gpt-4.1-mini", code=language)
    vision_critic_config = VisionCriticConfig(name="Vision Critic", model_name="gpt-4o")
    text_critic_config = TextCriticConfig(name="Text Critic", model_name="gpt-4o", code=language)
